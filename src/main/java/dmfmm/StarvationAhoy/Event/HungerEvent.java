...
public abstract class HungerEvent extends Event
{
	 ...
	 */
	public static class GetFoodValues extends HungerEvent
	{
	 ...
	 * This event does not have a result. {@link HasResult}<br>
	 */
	public static class GetPlayerFoodValues extends HungerEvent
	{
		public FoodValues foodValues;
		public final FoodValues unmodifiedFoodValues;
		public final ItemStack food;
	 ...
	 */
	@Cancelable
	public static class FoodStatsAddition extends HungerEvent
	{
