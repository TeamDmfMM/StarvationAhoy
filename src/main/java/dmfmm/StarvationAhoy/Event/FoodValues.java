...
public class FoodValues
{
	...
	{
		return StarvationAhoy.accessor.getUnmodifiedFoodValues(itemStack);
	}
	...
	{
		return StarvationAhoy.accessor.getFoodValues(itemStack);
	}
	...
	{
		return StarvationAhoy.accessor.getFoodValuesForPlayer(itemStack, player);
	}
