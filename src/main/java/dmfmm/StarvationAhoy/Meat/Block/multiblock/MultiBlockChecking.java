...
public class MultiBlockChecking {
    ...
    private static class BC  {
        ...
        public void crtn_a(World w){
            w.setBlock(x, y, z, MBlockLoader.HoldingStick);
        }
    ...
    public static boolean checkCookerStructure(World w, int x, int y, int z){
        ...
        if (w.getBlock(x, y, z+3) == MBlockLoader.Cooker){
            bpos0 = new BC(x, y, z);
        ...
        else if (w.getBlock(x, y, z-3) == MBlockLoader.Cooker){
            bpos0 = new BC(x, y, z);
            bpos3 = new BC(x, y, z-3);
            bpos2 = new BC(x, y, z-2);
            bpos1 = new BC(x, y, z-1);
        }
        else if (w.getBlock(x+3, y, z) == MBlockLoader.Cooker){
            bpos0 = new BC(x, y, z);
        ...
        n.z = bpos0.z;
        n.bPos = 0;
        ((CookerTileEntity) w.getTileEntity(bpos0.x, bpos0.y, bpos0.z)).multiBlockStructure = n;
        ...
        n.z = bpos1.z;
        n.bPos = 1;
        ((HoldingStickTileEntity) w.getTileEntity(bpos1.x, bpos1.y, bpos1.z)).multiBlockStructure = n;
        ...
        n.z = bpos2.z;
        n.bPos = 2;
        ((HoldingStickTileEntity) w.getTileEntity(bpos2.x, bpos2.y, bpos2.z)).multiBlockStructure = n;
        ...
        n.z = bpos3.z;
        n.bPos = 3;
        ((CookerTileEntity) w.getTileEntity(bpos3.x, bpos3.y, bpos3.z)).multiBlockStructure = n;
